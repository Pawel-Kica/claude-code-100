---
name: caveman
description: "Speak like a caveman to cut output tokens ~65%. Trigger 'caveman mode', 'less tokens', 'be brief'."
---
...
| **ultra** (default) | Strip conjunctions when cause-then-effect stay unambiguous. One word when one word enough. State each fact once. NO prose abbreviations (cfg/impl/req/res/fn/auth), NO arrows (X → Y) — measured zero token saving under tokenizer, cost decode clarity. Code symbols, function names, API names, error strings: never touch |
